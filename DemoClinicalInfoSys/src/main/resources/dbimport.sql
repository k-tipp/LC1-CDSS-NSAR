...
INSERT INTO cis.medication_drug VALUES (2,7680491560226);
INSERT INTO cis.medication_drug VALUES (2,7680465190350);
INSERT INTO cis.medication_drug VALUES (3,7680577870027);
 
INSERT INTO cis.medication_drug VALUES (4,7680527100570);
INSERT INTO cis.medication_drug VALUES (4,7680547520167);
INSERT INTO cis.medication_drug VALUES (5,7680489910330);
...
INSERT INTO cis.medication_drug VALUES (7,7680491560226);
INSERT INTO cis.medication_drug VALUES (7,7680465190350);
INSERT INTO cis.medication_drug VALUES (7,7680577870027);
INSERT INTO cis.medication_drug VALUES (8,7680531630179);
 
INSERT INTO cis.medication_drug VALUES (9,7680527100570);
INSERT INTO cis.medication_drug VALUES (10,7680465190350);
INSERT INTO cis.medication_drug VALUES (11,7680547520167);

/*DELETE FROM cis.medication_drug WHERE drugId < 999999;
DELETE FROM cis.medication WHERE medicationId < 999999;
DELETE FROM cis.labresult WHERE labresultId < 999999;
DELETE FROM cis.patient WHERE patientId < 999999;
